...
- **[Glados](https://github.com/AndrijaDJordjevic/Glados)** — a programming language written in Haskell
- **[R-Type](https://github.com/AndrijaDJordjevic/R-Type)** — networked multiplayer shoot'em up in C++
- **[Zappy](https://github.com/AndrijaDJordjevic/Zappy)** — network game: C server, raylib GUI, AI clients
